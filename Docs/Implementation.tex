\chapter{Implementation}
	...
	illumination where programmable where as today the GPUs become more generally
	programmable by the generation. Both of these shaders are described in
	section \ref{implshader}. 
	...
	\section{Reference Shader} \label{implshader}
		...
		\subsection{Bounding Spheres}
			...
			To decrease the number of distance calculations that has
