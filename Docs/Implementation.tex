\chapter{Implementation}
	...
	\section{Processor Unit} \label{implproc}
		...
		\subsection{Architecture}
			...
			to the global storage, or terminate their current threads either by 
			simply dropping them or by sending them to the frame buffer, where 
			some of the registers will be used to determine the color of some 
			pixel on the screen.
