\chapter{Implementation}
	...
	\section{Shaders} \label{implshader}
		...
		\subsection{Orthogonal Culling}
			...
			calculated on the CPU and then passed to the GPU (a.k.a Frustum
			culling\cite{frustum}). Even frustum culling might not be enough. Each
			ray should only care about the objects that it might hit, not all objects
