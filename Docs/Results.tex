\chapter{Results}
	...
	\section{Software Shader Performance}
		...
		not with our implementation, although our optimizations could certainly
		be used.
	...
	\section{Optimizations}
		...
		\subsection{Bounding spheres}
			...
			\begin{figure}[H]
				...
				\caption{Results from Bounding Sphere tests. Blue is optimized, red is without optimization}
				\label{boundsphere}
			\end{figure}
