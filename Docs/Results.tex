\chapter{Results}
	...
	\section{GPU}
		...
		The GPU has been tested by simulating it and running a program on it
	...
	\section{Optimizations}
		...
		Below are test results from Orthogonal culling.
			...
			\begin{table} \centering \begin{tabular}{lll} \hline Objects &
			Optimized & Unoptimized \\ \hline 1       & 600       & 350
			\\ 5       & 430       & 180         \\			10      & 290
			& 98          \\ 15      & 85        & 13          \\ 20      & 58
			& 9           \\ 25      & 40        & 6           \\ 30      & 29
			& 4           \\ 35      & 7         & 3           \\ 40      & 6
			& 2           \\ 45      & 4         & 1.5         \\ \hline
			\end{tabular} \caption{Frames generated per second using the GLSL
			shader with and without the orthogonal culling optimization.}
			\end{table}
			...
			{frames}{number of objects}{/figure/OptimizedGraf.txt} \end{table}
