\chapter{Discussion} 
	...
	\section{Optimizations} \label{optimization}
		...
		\subsection{Ray grouping}
			...
			marching steps by decreasing the total numer of initial rays. 
			
			We had initially expcted the performance improvements to be greater
			than those acheived. There is, however, a not insignificant amount
			of overhead incurred from splitting groups of rays into smaller
