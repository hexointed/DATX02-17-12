...
\chapter{Sphere Tracing} \label{spheretracing}
	...
	Tracing\cite{Hart1996}. The name is based on the fact that the algoritm
	...
	of the observer into the scene\cite{Shirley2005}. Sphere Tracing has been
	around since at least as early as the late eighties\cite{Hart1989} and Ray
	Tracing as early as the sixties\cite{Appel1968}.

	In this chapter the Sphere Tracing algorithm is discussied in detail with
	...
	\section{Sphere Tracing} 
		...
		\begin{figure}
			...
			\caption{Finding the intersection of an implicitly defined surface
				...
				origin alog the ray as show here.}
		\end{figure}
		...
		\subsection{Generalized Distance Functions}
			...
			$a$\cite{TODO}.  The union of signed distance bounds relates nicely
