...
\chapter{Sphere Tracing} \label{spheretracing}
	...
	Sphere Tracing works great for rendering detailed scenes with realistic
	lightsetting as seen here in \ref{AppendixRealLight}. Moreover it also allows
	for creating more complex objects from simpler primitive objects, using
	constructive solid geometry, as we will see later in \ref{CSG}. These objects
	can also be repeated and distorted at low costs to further create interesting
	shapes \ref{AppendixCoolObjWarp}.
