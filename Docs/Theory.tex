...
\chapter{Sphere Tracing} \label{spheretracing}
	...
	Sphere Tracing can render detailed scenes with lightsetting that is very
	close to how real light behaves, as seen here in \ref{AppendixRealLight}.
	Moreover it also allows for creating complex objects from simpler primitive
	objects using constructive solid geometry, as we will see later in \ref{CSG}.
	These objects can be repeated and distorted at low costs to create finely
	textured surfaces \ref{AppendixCoolSurface} or waterlike scenes
